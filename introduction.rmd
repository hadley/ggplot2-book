...
RStudio provides a number of cheatsheets, including for ggplot2, at <http://www.rstudio.com/resources/cheatsheets/>. These a great quick reference to help jog your memory.
...
To use ggplot2, you must first install it. Make sure you have a recent version of R (at least version 3.1.0) from <http://r-project.org> and then run the following line of code to download and install ggplot2:
...
```{r}
devtools::session_info(c("ggplot2", "dplyr"))
```

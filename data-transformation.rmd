...
When summarising with the mean or median, it's always a good idea to include a count and some measure of uncertainty. This helps you calibrate your assessments - if you don't include them you're likely to think that the data is less variable than it really is, and potentially draw unwarranted conclusions.

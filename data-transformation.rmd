...
* Repeat the analysis of outlying values to include the z dimension. Compared
  to x and y, how would you characterise the relationship of x and z, or y and 
  z?

* Look at the movies that have a missing budget. How are they different
  from the movies with a budget?

* What is `NA & FALSE` and `NA | TRUE`? Why? Why doesn't `NA * 0` equal zero? 
...
In only the simplest of cases will you apply only one of the verbs from 

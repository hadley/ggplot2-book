...
library("dplyr")
library("ggplot2")
knitr::opts_chunk$set(fig.width = 4, fig.height = 4, fig.align = "center", out.width = "0.49\\linewidth", fig.show = 'hold', message = FALSE, cache = TRUE, cache.path = "cache/data-", fig.path = "figure/data-")

...
* Switched from `qplot()` to `ggplot()` in the introduction. Feedback indicated 
  that `qplot()` was a crutch: it makes simple plots a little easier, but it 
...
* Overhauled the toolbox chapter to cover all the new geoms. I've added a
  ...
  detail elsewhere. The mapping section has been considerably expanded to 
  talk more about the different types of map data, and where you might find it.
...
Many people have contributed to this book with high-level structural insights, spelling and grammar corrections and bug reports. I'd particularly like to thank David Robinson, Guangchuang Yu, XXX, YYY and ZZZ, for their detailed technical review of the book.

...
*   If you want to label many points, it is difficult to avoid overlaps. 
    ...
    the ggrepel package <https://github.com/slowkow/ggrepel>. The package 
    supplies `geom_text_repel()`, which optimizes the label 

...
A second thing to note is that there are multiple ways to specify a valid scale for an aesthetic. In all of the examples above, I have used the default scales but provided non-default values for the arguments to the relevant scale function. However, you can also use a different scale altogether:

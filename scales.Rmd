...
Divide scales into three main groups, covered in separate chapters:

* Position scales and axes (Chapter \@ref(scale-position)).
* Colour scales and legends (Chapter \@ref(scale-colour)).
* Other scales for non-position aesthetics (Chapter \@ref(scale-other)).

The theory of scales is covered in Chapter \@ref(scales-guides)

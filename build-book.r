...
chapters <- c("introduction", "layers", "mastery", "position", "polishing", "qplot", "scales", "grid", "specifications", "toolbox", "translating",  "data", "duplication", "book-springer", "book-mine")

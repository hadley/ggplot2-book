...
files <- bomrang::get_available_imagery() %>%
  stringr::str_subset("202001072100") # Perhaps it's better to explicitly tell the reader that this time stamp needs to be changed to one day before reader's time.

# Perhaps it's better to explicitly tell the readers that they need to create a new folder called "raster" in their working directory before they run the following codes. Otherwise, it's prone to get errors if readers are beginners.

...
# Modelling {#cha:modelling}

Modelling is an essential tool for visualisation. It has two main uses that I'll discuss in this chapter:
...
But rather than just fitting one model, we're going to fit many models.

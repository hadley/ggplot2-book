...
* Scales chapter has been reorganised to focus on what you most commonly 
  want to do when manipulating scale objects: affect the appearance of the
  axes and legends. Updated to include the new guides and theme options.

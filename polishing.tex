...
% last_plot() + theme_bw()
\input{_include/05b09bc182c237cbe4af3534ece4a693.tex}
% END
...
% histogram
% 
% # Override the theme for a single plot by adding it
% histogram + theme_bw()
% 
...
\input{_include/bf037a7563e575c8db8a344a002eb093.tex}
% END
...
% p
% theme_set(old_theme)
\input{_include/450c69e20b3b04494923347adc599115.tex}
% END
...
\input{_include/babed0dbca6456ee00465f58452443b9.tex}
% END
...
% qplot(rating, data = movies, geom = "histogram", binwidth = 1)
\input{_include/7c277a593d53b9b625e2837e5dedbe95.tex}
% END
...
By default, showing a {\tt ggplot} object at the R command prompt will display to the screen.  

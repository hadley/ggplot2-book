...
% last_plot() + theme_bw()
\input{_include/c85c189c716ad76f7a294b59d4f05f94.tex}
% END
...
\input{_include/9f3f8d4c197b4a482f19964080b21c62.tex}
% END
...
\begin{itemize}
  ...
  \input{_include/f439d9bd92783385d83cfc10100d3e63.tex}  
  % END
  ...
  \input{_include/18b24ae69313f6882b96673587c791b5.tex}  
  % END

  \item \f{theme_rect} draws rectangles, mostly used for backgrounds, you can control the \code{fill} colour and border \code{colour}, \code{size} and \code{linetype}.  Examples shown in Figure~\ref{fig:theme-line} are created with the code below:
  ...
  \input{_include/0f806c76c989f844fc6580cbbd6b3acb.tex}  
  % END
  ...
  \input{_include/4c2150a242b1bf67fdbd38bcfcb83e2b.tex}  
  % END
...
% theme_set(old_theme)
\input{_include/8deff0e906a886d4d4a963bf3cadbd9c.tex}
% END
...
\input{_include/8bf24bb1ee02a6920af3b783057018b9.tex}
% END

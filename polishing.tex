...
% last_plot() + theme_bw()
\input{_include/906356e0f4ddc65d4f28cdf38b1332f3.tex}
% END
...
\begin{itemize}
  ...
  \input{_include/4fc525cb71172daa478b13305905310c.tex}  
  % END
  ...
  \input{_include/182fe125f11d2207fbb17f5146bb0c30.tex}  
  % END

  \item \f{theme_rect} draws rectangles, mostly used for backgrounds, you can control the \code{fill} colour and border \code{colour}, \code{size} and \code{linetype}.  Examples shown in Figure~\ref{fig:theme-background} are created with the code below:
  ...
  \input{_include/3ce949a05e9a19e9af2c97ac15984710.tex}  
  % END
  ...
  \input{_include/8cbb153690f23a1aa1d960cb56b6d8de.tex}  
  % END
...
% theme_set(old_theme)
\input{_include/c43ea43362531cc25f02ebd60fe6308b.tex}
% END
...
\input{_include/48f63a09e9feb3b1856f91d65727232c.tex}
% END
...
\input{_include/21eb8644ef2a223f6836667f2594fde3.tex}
% END

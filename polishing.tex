...
% last_plot() + theme_bw()
\input{_include/ec0653ef337ebbb258d3dd6019b88749.tex}
% END
...
\input{_include/c56d19110040bd2d35932ceae120bf22.tex}
% END
...
\subsection{Element functions} % (fold)
...
% p
% theme_set(old_theme)
\input{_include/643d0160eb56484423da3102714b6fce.tex}
% END
...
\input{_include/26d5b2934331b905169eda542302eb76.tex}
% END

\subsection{More advanced control}
\label{sub:more_advanced_control}

You can also write your own custom element functions.  You'll need to know more about grid to do this, so this is described in Section~\ref{sec:custom-elements}.
...
% qplot(rating, data=movies, geom="histogram", binwidth=1)
\input{_include/c03dc15839c758b00e7f2a658aaf4914.tex}
% END

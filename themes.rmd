...
Finally, the journal wants the figure as a 600 dpi TIFF file. You'll learn the fine details of `ggsave()` in [saving your output](#saving).
...
There are four other properties that control how legends are laid out in the context of the plot (`legend.position`, `legend.direction`, `legend.justification`, `legend.box`). They are described in [legend layout](#legend-layout).

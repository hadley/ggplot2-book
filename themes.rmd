...
### Legend elements
\index{Theme!legend} \index{Legend!styling}
...
### Facetting elements
\index{Theme!facets} \index{Faceting!styling}
...
When saving a plot to use in another program, you have two basic choices of  output: raster or vector: \index{Saving} \index{Exporting} \index{Saving output}

...
\input{_include/04bb41e66fdebc77a3a7daf0982ef9b8.tex}
% END
...
\input{_include/0e4bcc6b8b12de11aa348626c23a65c1.tex}
% END
...
\input{_include/1fa9f7bad2c348e74c4a077b288b1a89.tex}
% END
...
\input{_include/cc5dbd797e421bb46c01cb188a1d22e4.tex}
% END
...
\input{_include/de109f90cfd4974b516c2bcfff262350.tex}
% END
...
\input{_include/03bc27d96e0dcc9ba1d197941f5a0e9d.tex}
% END
...
\begin{itemize}
  ...
  % qplot(carat, price, data = dsmall, geom = c("point", "smooth"), 
  %   span = 1)
  \input{_include/84510a8a7a43a1d3c86711b3c9e3ecdc.tex}  
  % END
...
\index{Package!mgcv} \index{Model!generalised additive}
  ...
  \input{_include/15d8cbe909015daf7f766adbb6377043.tex}  
  % END
  ...
  \input{_include/bc58aee26fe9e407334242975bb79157.tex}  
  % END
...
\input{_include/03b337f82d0bddc15589cac5f58e7834.tex}
% END
...
% qplot(color, price / carat, data = diamonds, geom = "jitter",
%  alpha = I(1 / 200))
\input{_include/1c65c790f8803f984461524965429946.tex}
% END
...
\input{_include/49f917a67c6316a9d3e9efb57be12070.tex}
% END
...
%   xlim = c(0,3))
\input{_include/c1899a9ee269136310e79a0356ce7797.tex}
% END
...
\input{_include/8ef4670a5afe05ea3b78f33b263157ab.tex}
% END
...
\input{_include/5c560578e5061b2882a715150a8a070b.tex}
% END
...
\input{_include/f0390ab17b1f90c6ce3847301100e886.tex}
% END
...
\input{_include/24145a12025d055c6e9c5ab69d4d4eb5.tex}
% END
...
%   geom = "histogram", binwidth = 0.1, xlim = c(0, 3))
\input{_include/7f34da1aba1986b25c37f3837da274b8.tex}
% END
...
\input{_include/5aa992b0395f0b301f7ebeff10a1ae07.tex}
% END

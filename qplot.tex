...
\input{_include/4a6b6172f427f18165504173bb6e9adc.tex}
% END
...
\input{_include/ce6107772a330bd50964b471087b499d.tex}
% END
...
\input{_include/b7fc06f70b360a1ab8bc1ec48c541cf8.tex}
% END
...
\input{_include/307a8e65ac81433e4c8d23513e85c503.tex}
% END
...
\input{_include/dfd17c36a82b46dc51507f5c7a2e9f10.tex}
% END
...
\begin{itemize}
  ...
  \input{_include/2ea9bc1c5fd3ad2063df7b5a3748b6c3.tex}  
  % END
  ...
  \input{_include/73fec007c2a1a5841ab364a492d842f0.tex}  
  % END
...
to using a spline with {\tt lm}, but the degree of smoothness is estimated from the data.  For large data, use the formula {\tt y $\sim$ s(x, bs="cr")}
  ...
  \input{_include/869b1c117488adbd8307f953103621e2.tex}  
  % END
...
\input{_include/37daf53959432e9e00ebf52197a7c03d.tex}
% END
...
\input{_include/5f500d946697bdc57870593cf3e7f428.tex}
% END
...
\input{_include/afd5769284bd56f0571fb9edb25aed73.tex}
% END
...
\input{_include/ecd9943379f88837a6a3db784b1b47cf.tex}
% END
...
\input{_include/af8b4c377447cd77e2e8a0a2b7f61002.tex}
% END
...
\input{_include/e50dbe1e0d3e347e6d941b8a1fb803a2.tex}
% END
...
\input{_include/4835b3e9e21af690cf1669775e789179.tex}
% END
...
\input{_include/91f86549ebe943819d34440ffa7120ba.tex}
% END
...
\input{_include/511a90fb242035d7d573311e83141141.tex}
% END
...
\input{_include/88fbcc175d640825f9482e777cd58e70.tex}
% END
...
\input{_include/68dd35162ff0781c7f4ed2c70d05bf09.tex}
% END
...
% qplot(unemploy/pop, uempmed, data=economics, geom="path", size=year(date))
\input{_include/f36ee0027d66edad3f8abc1e2226333a.tex}
% END
...
\input{_include/1dec8ac5a399f9549f4f62a76dd03383.tex}
% END
...
\input{_include/f2abe7a72fae06af8b19c809bd2bfcef.tex}
% END

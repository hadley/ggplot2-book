...
\input{_include/6ed901c153aae58b0180bb252a79eab8.tex}
% END
...
\input{_include/332e663771f89a9f0d9cdd55dff15b8a.tex}
% END
...
%  CAPTION: Mapping colour (left), size (middle) and shape (right) of 
...
\input{_include/e5c8c9b3addc09493039acc925ce305f.tex}
% END
...
\input{_include/fb783514f6948d231bbce87d2c1aa73d.tex}
% END
...
\begin{itemize}
  ...
  \input{_include/a1f295c9db74b5991b2accf4df91f327.tex}  
  % END
  ...
  \input{_include/fb152bd8d4056c55e57043b88233dc62.tex}  
  % END
...
to using a spline with {\tt lm}, but the degree of smoothness is estimated from the data.  For large data, you should use the formula {\tt y $\sim$ s(x, bs="cr")}
  ...
  \input{_include/a9bc3a571fcc20ee7aa902f133640961.tex}  
  % END
...
\input{_include/a71ede3fbc99105c12df598a6b2675cf.tex}
% END
...
%   CAPTION: Like the smooth geom, you can modify the \code{formula} 
%    argument to control the functional form of the relation.  
%    ({\sc left}) A natural spline with five degrees of freedom,
%    {\tt formula = y ~ ns(x, 5)} and ({\sc right}) a linear model
%    with break points at 0.5, 1, and 1.5 carats, 
%    {\tt formula = y ~ x + I(x > 0.5) + I(x > 1) + I(x > 1.5))}
% 
...
\input{_include/d13bbb36d53b70e8fadfc912235a5c29.tex}
% END
...
\input{_include/395ac53792ad4691cf0ff41277ce5293.tex}
% END
...
\input{_include/ddb0094b0aeb1747f56b9659bd6075b1.tex}
% END
...
\input{_include/b8547c1119ad3a17c79c3f329676d656.tex}
% END
...
\input{_include/708a95a23c324bc46a2654ccf1563baa.tex}
% END
...
\input{_include/26808ab8cd54309f33eadac2352fa6e7.tex}
% END
...
%    carats. X zoomed in to show only bins between 0 and 3 carats. 
%   TEX-WIDTH: 0.33\textwidth
%
% qplot(carat, data=diamonds, geom="histogram", binwidth=1, xlim=c(0,3))
% qplot(carat, data=diamonds, geom="histogram", binwidth=0.1, xlim=c(0,3))
% qplot(carat, data=diamonds, geom="histogram", binwidth=0.01, xlim=c(0,3))
\input{_include/c7a1d143184e8797efef9d49e46e7bd9.tex}
% END
...
\input{_include/7524b4814877959e431323c722279a15.tex}
% END

\subsection{Bar charts}
\label{sub:bar}

The discrete analogue of histogram is the bar chart, \code{geom = "bar"}.  The bar geom takes care of counting the number of instances of each class for you.  If you have already counted them yourself, or you'd like weight by another continuous variable, you can use the \code{weight} geom.  Illustrated in Figure~\ref{dist-bar}.

% FIGURE
%   LABEL: dist-bar
%   CAPTION: Bar charts of diamond colour.  The (left) shows counts, and the 
%   (right) is weighted with \code{weight = carat} and shows total number
%   of carats of diamonds of each colour.
% 
% qplot(colour, data=diamonds, geom="bar")
% qplot(colour, data=diamonds, geom="bar", weight = carat)
...
Faceting tables of graphics by splitting the data into subsets, and displaying the same graph for each subset.   This example displays a histogram of price for each value of cut:

% INTERWEAVE
% 
% qplot(carat, data=diamonds, facets=color ~ ., geom="histogram", binwidth=0.1)
\input{_include/c3ce3c0e26c2b47a21fcb721dabc5824.tex}
% END
...
Faceting is used to investigate conditional relationships, e.g. conditional on sex, what is the relationship between amount of smoking and lung cancer.
...
\input{_include/8cd67f371e264c242494593786a8c304.tex}
% END

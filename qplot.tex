...
\input{_include/fecb4affef4352d2180a315fda1e6e80.tex}
% END
...
\input{_include/17cc113da52ad7a6cb85c3395c1ac341.tex}
% END
...
\input{_include/20511b8ce5a24818459846451e249544.tex}
% END
...
\input{_include/c800a9de6878db7ade40c70857f253df.tex}
% END
...
\input{_include/cc9e89d5780a6d72fbccb9ec485aa8f7.tex}
% END
...
\begin{itemize}
  ...
  \input{_include/c52375886f434f6119b1f3578a572925.tex}  
  % END
  ...
  \input{_include/814b85a0d896f5d5e109e8efabd6891a.tex}  
  % END
...
to using a spline with {\tt lm}, but the degree of smoothness is estimated from the data.  For large data, use the formula {\tt y $\sim$ s(x, bs="cr")}
  ...
  \input{_include/3a460af6896b7430a49724a583166922.tex}  
  % END
...
\input{_include/cd56501114d5d94b5be3e1cf42de2670.tex}
% END
...
\input{_include/450456b6433c20c49c9b64a383612806.tex}
% END
...
\input{_include/3587b0c1e73fdd05f60fb2e763708e93.tex}
% END
...
\input{_include/cea7b2c8f6e6da9140e9b7e00fa35e15.tex}
% END
...
\input{_include/721bb7564007bbd48b6413bfef59a768.tex}
% END
...
\input{_include/2a66da6a8bd2683e89dbdb4d445eea8d.tex}
% END
...
\input{_include/703ec7582bf5f4df32d7dd66ec425413.tex}
% END
...
\input{_include/ab7a416923664a9172f58812d07488c7.tex}
% END
...
\input{_include/3574405fab75d174dbae18df0261e092.tex}
% END
...
\input{_include/244184ebc0b9e3589e725a99c9bff649.tex}
% END
...
\input{_include/df84b4b3d204f8eacb9dc58cf0f9063c.tex}
% END
...
% qplot(unemploy/pop, uempmed, data=economics, geom="path", size=year(date))
\input{_include/9ed62103baefe0ad1e25d5fc2ab14b94.tex}
% END
...
\input{_include/661341850e80b0b9de0119358519ed3e.tex}
% END
...
\input{_include/2147ac51b40857aa53854528ff0dadff.tex}
% END

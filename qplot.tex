...
\input{_include/34359af61ab9ee97567517e2d68b2117.tex}
% END
...
\input{_include/31b870064e68e751477233bc74d85a8c.tex}
% END
...
\input{_include/a63d3be75b778931330b7e14db50e247.tex}
% END
...
\input{_include/53af362af78ceb6c48a0b39df394fe25.tex}
% END
...
\input{_include/bb9081584cb9388b0e1a9e5004af6979.tex}
% END
...
\begin{itemize}
  ...
  \input{_include/21d9a3cc85c401ca3d6cb12bf7518206.tex}  
  % END
  ...
  \input{_include/c5d3b401b63de3bd27c7a10da22dee72.tex}  
  % END
...
to using a spline with {\tt lm}, but the degree of smoothness is estimated from the data.  For large data, use the formula {\tt y $\sim$ s(x, bs="cr")}
  ...
  \input{_include/4882ce2f6672dfeaebefd48e4d07bfcd.tex}  
  % END
...
\input{_include/d2ad46f53cce8a3333ac48ad2f81b46e.tex}
% END
...
\input{_include/8e0b6c289e454c8be2050496c4ec517a.tex}
% END
...
\input{_include/4ad94d0ea239ff8746220bd714cd8236.tex}
% END
...
\input{_include/6462a64173901b16f9974ee5f6faef86.tex}
% END
...
\input{_include/4909eb8719aee7179fe58b7c862c0366.tex}
% END
...
\input{_include/635dd0491b152e84c419bc4687187cd4.tex}
% END
...
\input{_include/8555ec1777b82cca542c0dd15c07a4f6.tex}
% END
...
\input{_include/bb38cbf295e2996ffe466f9b852efe8c.tex}
% END
...
\input{_include/16354bd312c99651d38a8f33d682a909.tex}
% END
...
\input{_include/c8fd12b71b85b9edad5301c251346a89.tex}
% END
...
\input{_include/609d45ae9c089180eb3d875050caadfb.tex}
% END
...
% qplot(unemploy/pop, uempmed, data=economics, geom="path", size=year(date))
\input{_include/e6ae381998f8043a5e3d73bc0446d0c1.tex}
% END
...
\input{_include/12876f9555b8c5dc723900101d57bbd7.tex}
% END
...
\input{_include/c4c83cd1c442169bf8f3fc946c79239a.tex}
% END

...
> qplot(carat, price, data = diamonds)
\end{alltt}
\includegraphics[scale=0.5]{./include/bf59caca1988c419c8bc7f8c334f088c.pdf}
\begin{alltt}
...
> qplot(log(carat), log(price), data = diamonds)
\end{alltt}
\includegraphics[scale=0.5]{./include/f44d5427c103189e22154ae9d7892bcc.pdf}
\begin{alltt}

> qplot(carat, x * y * z, data = diamonds)
\end{alltt}
\includegraphics[scale=0.5]{./include/d6b20c99a5367ab5021071a5a6939f51.pdf}
\begin{alltt}
...
> qplot(carat, price, data = dsmall, colour = colour)
\end{alltt}
\includegraphics[scale=0.5]{./include/ddfe6de490eff0edb0e83648201773d7.pdf}
\begin{alltt}

> qplot(carat, price, data = dsmall, size = clarity)
\end{alltt}
\includegraphics[scale=0.5]{./include/49eb48232db8ceb6fc5a5aa3be33a060.pdf}
\begin{alltt}

> qplot(carat, price, data = dsmall, shape = cut)
\end{alltt}
\includegraphics[scale=0.5]{./include/6660dc6628133e683fd42cb199326936.pdf}
\begin{alltt}
...
> qplot(mpg, wt, data = mtcars, geom = c("point", "smooth"))
\end{alltt}
\includegraphics[scale=0.5]{./include/c7b7c0b37e89849db40d11facdf58c2f.pdf}
\begin{alltt}
...
> qplot(year, a, data = df, geom = "line")
\end{alltt}
\includegraphics[scale=0.5]{./include/7a945c50855ed26d8e07169f1ef71840.pdf}
\begin{alltt}
...
> qplot(a, b, data = df, geom = "path")
\end{alltt}
\includegraphics[scale=0.5]{./include/3644a925728049ced3e9434be63caf27.pdf}
\begin{alltt}
...
> qplot(wt, factor(cyl), data = mtcars, geom = "jitter")
\end{alltt}
\includegraphics[scale=0.5]{./include/37e58529bc249511a38ccba663e743e1.pdf}
\begin{alltt}

> qplot(wt, factor(cyl), data = mtcars, geom = "boxplot")
\end{alltt}
\includegraphics[scale=0.5]{./include/79572eb0bc0b2e211346398a3fcbd0cc.pdf}
\begin{alltt}
...
> qplot(wt, data = mtcars, geom = "histogram")
\end{alltt}
\includegraphics[scale=0.5]{./include/72c549ea7a46589e6fa7091242ed250c.pdf}
\begin{alltt}

> qplot(wt, data = mtcars, geom = "density")
\end{alltt}
\includegraphics[scale=0.5]{./include/66137e9f3bf7cebb0a78386fb865a7fa.pdf}
\begin{alltt}
...
> qplot(wt, data = mtcars, geom = "histogram", binwidth = 0.1)
\end{alltt}
\includegraphics[scale=0.5]{./include/b97196be7f082b37a4db24c564c7f500.pdf}
\begin{alltt}

> qplot(wt, data = mtcars, geom = "density", adjust = 0.5)
\end{alltt}
\includegraphics[scale=0.5]{./include/22a3bf84cefa0d673e745855df35928d.pdf}
\begin{alltt}
...
> qplot(wt, data = mtcars, geom = "density", colour = factor(cyl))
\end{alltt}
\includegraphics[scale=0.5]{./include/a20ff3200a4a256b19ff9ba20db71528.pdf}
\begin{alltt}
...
> qplot(year, value, data = dfm, geom = c("line", "point"), colour = variable)
\end{alltt}
\includegraphics[scale=0.5]{./include/eb9c66dad1cc69e256a6fb083ca44f3a.pdf}
\begin{alltt}
...
> qplot(mpg, factor(cyl), data = mtcars, geom = c("jitter", "boxplot"))
\end{alltt}
\includegraphics[scale=0.5]{./include/478d5cefc1ab51f28f478c201d53056f.pdf}
\begin{alltt}

> qplot(mpg, factor(cyl), data = mtcars, geom = c("boxplot", "jitter"))
\end{alltt}
\includegraphics[scale=0.5]{./include/3467dd42686853326e83f14a69979a8d.pdf}
\begin{alltt}
...
> qplot(wt, 0, add = p)
\end{alltt}
\includegraphics[scale=0.5]{./include/74d21155214e3577b04bb1e142988673.pdf}
\begin{alltt}

> qplot(wt, 0, add = p, geom = "jitter")
\end{alltt}
\includegraphics[scale=0.5]{./include/df06eb773e1b8f6422818e55f99e1fff.pdf}
\begin{alltt}
...
> (p <- qplot(mpg, wt, data = mtcars, colour = factor(cyl)))
\end{alltt}
\includegraphics[scale=0.5]{./include/689e352a36ce167f0064534047035518.pdf}
\begin{alltt}
...
+     add = p)
\end{alltt}
\includegraphics[scale=0.5]{./include/56e3c5fd92862d033b16494e1b71394a.pdf}
\begin{alltt}
...
> qplot(mpg, wt, data = mtcars, facets = . ~ cyl)
\end{alltt}
\includegraphics[scale=0.5]{./include/0b47fe7ee6f302db2e3cc03598162f8f.pdf}
\begin{alltt}
...
> qplot(mpg, wt, data = mtcars, facets = vs ~ cyl)
\end{alltt}
\includegraphics[scale=0.5]{./include/32e54098b6249f87077d983c0fc59253.pdf}
\begin{alltt}
...
> qplot(mpg, wt, facets = vs ~ am, data = mtcars, margins = TRUE)
\end{alltt}
\includegraphics[scale=0.5]{./include/f74c939ea39a57550da4578063c118e8.pdf}
\begin{alltt}
...
\end{alltt}
\includegraphics[scale=0.5]{./include/1715da2f66c4168037480bc85bbae2db.pdf}
\begin{alltt}

> qplot(wt, mpg, data = mtcars, xlab = expression(miles/gallon), 
+     ylab = "weight", main = "Small cars", ylim = c(10, 20))
\end{alltt}
\includegraphics[scale=0.5]{./include/678a85bdbe0a7f50a580d20c16383977.pdf}
\begin{alltt}

> qplot(wt, mpg, data = mtcars, main = "Small cars", ylim = c(10, 
+     20), log = "xy")
\end{alltt}
\includegraphics[scale=0.5]{./include/e51ee8f524139f8e6fa022c87418b76e.pdf}
\begin{alltt}

...
\input{_include/7a35e423517b29e066a0835d0df7cab7.tex}
% END
...
\input{_include/c4fed478759fc029853ba06802ef66e8.tex}
% END
...
\input{_include/0e9cc76f309b83d50c2f9e63f6e5d3d7.tex}
% END
...
\input{_include/6a86d9af28bd236795eba9f660efcff0.tex}
% END
...
%   CAPTION: Mapping point colour (left), size (middle) and shape (right) of 
%   cut quality.
% 
% qplot(carat, price, data = dsmall, colour = color)
% qplot(carat, price, data = dsmall, shape = cut)
\input{_include/bfc566d3bbde5778a982c1a6c8c7600c.tex}
% END
...
%   1/200 (right) makes it easier to see where the bulk of the points lie.
...
\input{_include/b9b10896099565930b4463863549dd91.tex}
% END
...
\input{_include/fe5a6cb9f9ef46ed218a236f931d827e.tex}
% END
...
\begin{itemize}
  \item {\tt method = "loess"}, the default for small n, uses a smooth local regression.  More details about the algorithm used can be found in {\tt ?loess}.  The wiggliness of the line is controlled by the \code{span} parameter, which ranges from 0 (exceeding wiggly) to 1 (not so wiggly), as shown in Figure~\ref{fig:smooth-loess}.  
  ...
  % qplot(carat, price, data = dsmall, geom = c("point", "smooth"), 
  %   span = 1)
  \input{_include/70b939a1503ae57e20f0e3f0cb14688c.tex}  
  % END
  ...
  \input{_include/f669c1900917d54793ade8a10e1e2ef1.tex}  
  % END
  ...
  \input{_include/54b0c7cfaeb06e30c256336dc4477c57.tex}  
  % END
...
\input{_include/19cd0872de08befd6f3d5862542488bc.tex}
% END
...
\input{_include/d3936faeff1bb97692687a9662d2a90b.tex}
% END
...
\input{_include/99c2a814d80e4e5e5897af05bee64bb0.tex}
% END
...
%   xlim=c(0,3))
\input{_include/c38f2cdda467ed664b4a3e09f6672b02.tex}
% END
...
\input{_include/23af738fa963c1508e34c2c5260619c7.tex}
% END
...
\input{_include/1b4fbbcf99e6916297116c2cbfb4c6a2.tex}
% END
...
\input{_include/3b314474a6916c3001a97ce3bbd4f710.tex}
% END
...
\input{_include/13fed3b38283b1b911ed9a774533853d.tex}
% END
...
%   colour.  (Left) bars show counts and ({\sc right}) bars show
...
\input{_include/d69bdcd7fd01bd92ead1b3d786c2beed.tex}
% END
...
\input{_include/b7e2d7eb0a4929aa84ba00b699df2aed.tex}
% END

...
\begin{itemize}
	...
	\item The use of facetting, also known as trellising or conditioning, to break apart subsets of your data, \secref{sec:facetting}.
...
\input{_include/d3aed250031793f82adcf9d66069f2dc.tex}
% END
...
\input{_include/85907b54290a0c7d87931a21c21b7ea2.tex}
% END
...
\input{_include/de24b352b3723c5593283f95280ccdc3.tex}
% END
...
\input{_include/bf6316bd7c6faec00f1794b6a554d7c3.tex}
% END
...
\input{_include/3e97903121c98dcfe77985aeebb80475.tex}
% END
...
\begin{itemize}
  ...
  \input{_include/3b1e067ac44ab20b0a03c92cf08de070.tex}  
  % END
  ...
  \input{_include/7f65d43df5076586f0e5dfce11de6c3d.tex}  
  % END
...
to using a spline with {\tt lm}, but the degree of smoothness is estimated from the data.  For large data, use the formula {\tt y $\sim$ s(x, bs="cr")}
  ...
  \input{_include/47e88a3137bf27cc0ee3e249ec73d1b0.tex}  
  % END
...
\input{_include/4a471d07dbef9e15a2ac145d8de613ff.tex}
% END
...
\input{_include/b96854223c7345430f205d401b8a0bfb.tex}
% END
...
\input{_include/8a9e5701439c6d8354cfaa7847114a5d.tex}
% END
...
\input{_include/defb4bf8df6ffaf4219380f2ad8a16db.tex}
% END
...
\input{_include/27f9a0b51f93a5944a1fbfa8352ab978.tex}
% END
...
\input{_include/86708c902490455a9d36051452f6ccd1.tex}
% END
...
\input{_include/ea17e897c58ba2540422d0f4098924a6.tex}
% END
...
\input{_include/7d2968a1435e99be612f7fccbe6d15b9.tex}
% END
...
\input{_include/0762b691ee9f45d4e2d6d8578d5f3ea3.tex}
% END
...
\input{_include/6723ee464d095ad67b3c2d5f73089259.tex}
% END
...
\input{_include/fd3ac64d20963d12988119343da91d7f.tex}
% END
...
% qplot(unemploy/pop, uempmed, data=economics, geom="path", size=year(date))
\input{_include/699598e7b77126208c4e14370dce6abc.tex}
% END
...
\input{_include/c6a1883d8ad8a78c9ef7d3b7d2e42eda.tex}
% END
...
\input{_include/b94a138cb46ca29cb5e7c2ec8ab69a84.tex}
% END

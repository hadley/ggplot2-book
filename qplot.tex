...
\input{_include/e4696b4a251d3a9b6375204de4f36907.tex}
% END
...
\input{_include/1af3bb7efa4faf347e330df86115044d.tex}
% END
...
%  TEX-WIDTH: 0.33\textwidth GG-WIDTH: 4in GG-HEIGHT: 4in
% 
% qplot(carat, price, data=dsmall, colour=cut)
% qplot(carat, price, data=dsmall, size=cut)
% qplot(carat, price, data=dsmall, shape=cut)
\input{_include/c8988e03c780292a60acf38e8c94e777.tex}
% END
...
\begin{itemize}
  ...
  \input{_include/6103710852eba0b0092916e498273282.tex}  
  % END
...
to using a spline with {\tt lm}, but the degree of smoothness is estimated from the data.  For large data, you should use the formula {\tt y $\sim$ s(x, bs="cr")}
  ...
  \input{_include/1f5f2cd71686eeda70b99de960f65ce6.tex}  
  % END
...
\input{_include/91ee16e9ac8440325ddf21472f20241c.tex}
% END
...
\input{_include/05101c489e5f7b24eccaf6f3d581b8e6.tex}
% END
...
\input{_include/7a2b4643c3e2d1c73f1cedd3014fcb58.tex}
% END
...
\input{_include/5848cd82b79190c45de437ff4910855c.tex}
% END
...
\input{_include/b83201b56bdf1be943a22651d8a8b9cb.tex}
% END
...
\input{_include/cb8a4e90f9c52e1c38c8d18609ce9696.tex}
% END
...
\input{_include/23fe9df4d044931ab8617833eeac9231.tex}
% END
...
\input{_include/2d8ac316c4566203355ef4887f952a9b.tex}
% END
...
\input{_include/e03bec7a3f9de5f22d7778d129036c28.tex}
% END
...
% INTERWEAVE
% 
% qplot(carat, data=diamonds, facets= colour ~ ., geom="histogram", binwidth=0.1)
\input{_include/5bd67ec93af66924b674453fae165603.tex}
% END
...
\input{_include/c79b4f4ff19937858db656239ee4a730.tex}
% END

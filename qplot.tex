...
\begin{itemize}
  \item must specify both x and y
  
  \item not generic
  
  \item annotations work very differently
  
  \item adding working different.ly
  
  \item ggplot2 doesn't have subtitles, so there is no {\tt sub} parameter.    
  
  \item While you can continue to use the base R aesthetic names ({\tt col}, {\tt mapping between R aesthetics and ggplot2
\end{itemize}

...
# Varying the alpha level.  From left to right:
# $1/5$, $1/50$, $1/200$.  As the opacity decreases
...
# (Left) Density plots are overlaid and (right)
# histograms are stacked.
qplot(carat, data = diamonds, geom = "density", colour = color)
qplot(carat, data = diamonds, geom = "histogram", fill = color)

# Bar charts of diamond colour.  The left plot shows
# counts and the right plot is weighted by
# \code{weight = carat} to show the total weight of
# diamonds of each colour.

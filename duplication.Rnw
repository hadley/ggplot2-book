...
<<duplication, echo=FALSE>>=
knitr::set_parent('knit-book.Rnw') # allows us to compile as an individual document
knitr::opts_chunk$set(cache.path = "cache/duplication-", fig.path = "figure/duplication-")
options(digits = 2)
@
...
<<pcp_data, fig.width=8, out.width="0.75\\linewidth", fig.show='asis', prompt=TRUE>>=

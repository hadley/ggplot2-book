...
After all statistics have been computed, the domain is calculated for the data in each layer.  The individual domains are then combined to get a global domain, across all layers. 

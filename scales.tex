...
\input{_include/14f3a9351a5b2e333c033ad1c74e5a50.tex}
% END
...
\begin{itemize}
  ...
  % p + scale_colour_gradient("The amount of the tip\ndivided by the total bill")
  % p + scale_colour_gradient(expression(frac(tip, total_bill)))
  \input{_include/41b86e4bb5113ad7ff20f3a6eda3cfdf.tex}  
  % END
  ...
  \input{_include/319aac9632d6ca55108ce9764a4e7aca.tex}  
  % END
...
\input{_include/b8da5a1abfe13e035b9dae530d293d4f.tex}
% END
...
\input{_include/742ebd71dd7824710a1d9b781dd09c1b.tex}
% END
...
\input{_include/94b8f50a8bfbc253ff8bb08271573bd8.tex}
% END
...
%    coord_equal()
\input{_include/7019a7d5a7d39b9ce5eab58bb6b3feb1.tex}
% END
...
\input{_include/482fdadc736b0c898fc1ba9bb60709d2.tex}
% END

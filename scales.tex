...
\input{_include/51fd950239b3934b665d7a0b98094ea7.tex}
% END
...
\begin{itemize}
  ...
  % p + scale_colour_gradient("The amount of the tip\ndivided by the total bill")
  % p + scale_colour_gradient(expression(frac(tip, total_bill)))
  \input{_include/08ee8e3bb58410a0b8cb41a88226d696.tex}  
  % END
...
\input{_include/e81b3321af4638275fd91e367d835166.tex}
% END
...
\input{_include/9533906e477e84539b7941658e23c481.tex}
% END
...
\input{_include/1cebe954c5e32b3d14762e1623901577.tex}
% END
...
In your original example, this is equivalent to operating on the molten data and using geom_line(aes(colour = variable), data = molten)
...
\input{_include/0dd28abf9f64f4885bd839924a9f2e28.tex}
% END

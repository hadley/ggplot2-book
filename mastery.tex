...
\begin{table}
  ...
  \end{tabular}
  \end{center}
  \caption{The first 10 cars in the \code{mpg} data set, included in the \ggplot package.  \var{cty} and \var{hwy} record miles per gallon (mpg) for city and highway driving respectively, and \code{displ} is the engine displacement in litres.}
  \label{tbl:mpg}
\end{table}
...
% 
\input{_include/c91cf33aa5768f5d9803e9c59f60efc4.tex}
% END
...
\begin{table}[ht]
  ...
  \end{tabular}
  \end{center}
  \caption{First 10 rows from \code{mpg} rearranged into the format required for a scatterplot.  This is data frame contains all the data to be displayed on the plot.}
  \label{tbl:mapping}
\end{table}
...
%   make sense for this data, but they are still grammatically valid.
% 
...
%   opts(drop = "legend_box")
\input{_include/382de8e27fd224e2eceff44a9ef78adb.tex}
% END
...
\input{_include/9206b0eccbecb39c53e7c7c014a46838.tex}
% END
...
\input{_include/01204aecbe66de205488015a215fb3cd.tex}
% END
...
\input{_include/100846273e3a7c05c9d40494d9a63325.tex}
% END
...
% p + coord_polar()
\input{_include/41cbe148769b1a0cfbb73e617158c8aa.tex}
% END

...
We see that once again our constructor is a very thin wrapper around `gTree()`. All this is doing is ensuring that arguments are converted to units if necessary, and then returning a grob with class "spring". 

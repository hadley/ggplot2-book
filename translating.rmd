...
* Within `ggplot`, [from `qplot()` to `ggplot()`](#sec:qplot-ggplot).
* [From base graphics](#sec:translate-base).
* [From lattice graphics](#sec:translate-lattice).
* [From __gpl__](#sec:translate-gpl).

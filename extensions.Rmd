...
PositionJitterNormal <- ggproto('PositionJitterNormal', Position,
  ...
  setup_params = function(self, data) {
    if(is.null(self$sd_x)) {
      self$sd_x <- .15
    }
    if(is.null(self$sd_y)) {
      self$sd_y <- .15
    }
    return(self)
  },

...
In this chapter we will go through the different ways ggplot2 can be extended, and discuss any specific issues you may need to be aware of. The later chapter will showcase the development of specific extensions.

...
All ggplot2 objects are built using the **ggproto** system for object oriented programming, and is unusual in that it is used only by ggplot2. This something of a historical accident: ggplot2 originally used proto [@proto] for object oriented programming, which became a problem once the need for an official extension mechanism arose due to the limitations of the proto system. Attempts to switch ggplot2 to other systems such as R6 [@R6] proved difficult, and creating an object oriented system specific to the needs of ggplot2 turned out to be the least bad solution. 

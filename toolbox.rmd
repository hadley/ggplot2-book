...
*   `size` controls the font size. Unusually, it's measured in mm, rather
    ...
    units in ggplot2. To convert from points to mm, just divide by 2.83.
    
<!-- TODO
  What do you think about linking to stackoverflow posts? I thought this was useful for gaining a better understanding of what you're saying here ^^^ -> http://stackoverflow.com/questions/17311917/ggplot2-the-unit-of-size
-->
...
Labels can also serve as an alternative to a legend. This generally makes the plot easier to read because it puts the lookup table closer to the data. The directlabels package provides a number of tools to make this easier:

<!-- TODO
  Cite and/or index directlabels?
-->
...
An additional limitation for paths and lines is that line type must be constant over each individual line, in R there is no way to draw a line which has varying line type. \indexf{geom_line} \indexf{geom_path}
...
*   If there is some discreteness in the data, you can randomly jitter the 
    ...
    discreteness. \index{Jittering} \indexf{geom_jitter}

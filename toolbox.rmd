...
* Adding arbitrary additional anotations, Section \@ref(annotations).
...
In Section \@ref(diamonds), you'll learn about the diamonds dataset. The final three sections use this data to discuss techniques for visualising larger datasets:
...
The chapter concludes in Section \@ref(elsewhere) with some pointers to other useful packages built on top of ggplot2.

...
*   `geom_text()` adds labels at the specified points. It requires another 
    aesthetic: `label`.  It also has optional aesthetics `hjust` and `vjust` 
    that control the horizontal and vertical position of the text; `angle` 
    which controls the rotation of the text; and `family`, `fontface`, and 
    `size` to control the apperance of the font. See 
    [specifications](#cha:specifications) for more details. 

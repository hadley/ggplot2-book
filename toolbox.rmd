...
See [annotations](#sec:annotating) for more details on how to add plot titles, and ways to add a single label (i.e. not mapped from data) to the plot.

...
<<qplot, echo=FALSE>>=
library("ggplot2")
knitr::opts_chunk$set(fig.width = 4, fig.height = 2.4, out.width = "0.5\\linewidth", message = FALSE, cache = TRUE, cache.path = "cache/qplot-", fig.path = "figure/qplot-")
@
...
<<labels, fig.width = 4, fig.height = 4, fig.show='hold', out.width="0.4\\linewidth">>=
qplot(

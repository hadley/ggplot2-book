...
You'll learn the fine details of `ggsave()` in Section \@ref(saving).
...
They are described in Section \@ref(legend-layout).
...
Figure \@ref(fig:vector-raster) illustrates the basic differences in these formats for a circle.

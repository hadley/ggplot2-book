...
Note the use of `%o%` to quickly generate expand the multiplication table, and that the minor breaks must be supplied on the transformed scale. \index{Log ticks}

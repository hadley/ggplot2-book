...
\noindent  This section describes each group in more detail.  Precise details about individual scales can be found in the documentation, within R (e.g., `?scale_brewer`), or online at  <http://docs.ggplot2.org/>.

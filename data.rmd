...
pander::pandoc.table(head(em), caption = "Economics data in wide, left, and long, right, formats. The data stored in each table is equivalent, just the arrangement is different. It it easy to use the wider format with `ggplot` to produce a line for each variable.")
```

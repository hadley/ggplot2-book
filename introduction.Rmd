...
Then Chapters \@ref(scale-position) to \@ref(other-aesthetics) show how you to control the most important scales, allowing you to tweak the details of axes and legends.

...
<!-- HW: I wonder if we should suppress the y axis in all of these plots to give a bit more space -->
...
```{r}
base + scale_x_continuous(labels = NULL)
```
...
<!-- HW: Expand the table to also include scale names where they exist? -->

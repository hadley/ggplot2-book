...
<!-- DN: Parking this example here momentarily -->
...
Other colour scales exist and are worth noting briefly:

- `scale_colour_date()` and `scale_colour_datetime()` are designed to handle date data, analogous to the date scales discussed in Section \@ref(date-scales).

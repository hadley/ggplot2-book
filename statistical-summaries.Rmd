...
If you want the opposite, see Section \@ref(coord-flip).
...
The data contains the four C's of diamond quality: carat, cut, colour and clarity; and five physical measurements: depth, table, x, y and z, as described in Figure \@ref(fig:diamond-dim).
...
-   Estimate the 2d density with `stat_density2d()`, and then display using one of the techniques for showing 3d surfaces in Section \@ref(surface).

-   If you are interested in the conditional distribution of y given x, then the techniques of Section \@ref(distribution) will also be useful.
...
In this context the `..` notation refers to a variable computed internally (see Section \@ref(generated-variables)).

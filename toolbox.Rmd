...
-   Basic plot types that produce common, 'named' graphics like scatterplots and line charts, Section \@ref(basics).

-   Displaying text, Section \@ref(text-labels).
...
-   Revealing uncertainty and error, with various 1d and 2d intervals, Section \@ref(uncertainty).
...
-   Displaying distributions, continuous and discrete, 1d and 2d, joint and conditional, Section \@ref(distributions).

-   Dealing with overplotting in scatterplots, a challenge with large datasets,\
    Section \@ref(overplotting).

-   Displaying statistical summaries instead of the raw data, Section \@ref(summary).

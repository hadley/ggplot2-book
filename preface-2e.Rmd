...
* Overhauled the toolbox chapter, Chapter \@ref(toolbox), to cover all the 
  ...
  [labels](#labelling), since it's important and not covered in 
  detail elsewhere. The mapping section, [maps](#maps), has been considerably
...
* Completely rewritten the scales chapter, Chapter \@ref(scales), to focus on 
  ...
  control over legend appearance, [legends](#legends), and shows off some 
  of the new scales added to ggplot2, [scales](#scale-details).

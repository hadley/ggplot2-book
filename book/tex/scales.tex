...
\begin{figure}
\includegraphics[width=0.49\linewidth]{figures/scale-adjust-2} \caption{Adjusting the default parameters of a scale. (Top left) The plot with default scale. (Top right) Adding the default scale by hand doesn't change the appearance of the plot. (Bottom left) Adjusting the parameters of the scale to tweak the legend. (Bottom right) Using a different colour scale: Set1 from the ColorBrewer colours.\label{fig:scale-adjust2}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.49\linewidth]{figures/scale-adjust-3} \caption{Adjusting the default parameters of a scale. (Top left) The plot with default scale. (Top right) Adding the default scale by hand doesn't change the appearance of the plot. (Bottom left) Adjusting the parameters of the scale to tweak the legend. (Bottom right) Using a different colour scale: Set1 from the ColorBrewer colours.\label{fig:scale-adjust3}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.49\linewidth]{figures/scale-adjust-4} \caption{Adjusting the default parameters of a scale. (Top left) The plot with default scale. (Top right) Adding the default scale by hand doesn't change the appearance of the plot. (Bottom left) Adjusting the parameters of the scale to tweak the legend. (Bottom right) Using a different colour scale: Set1 from the ColorBrewer colours.\label{fig:scale-adjust4}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/legend-names-1} \caption{A demonstration of the different forms legend title can take.\label{fig:legend-names1}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/legend-names-2} \caption{A demonstration of the different forms legend title can take.\label{fig:legend-names2}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/legend-names-3} \caption{A demonstration of the different forms legend title can take.\label{fig:legend-names3}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/legend-names-4} \caption{A demonstration of the different forms legend title can take.\label{fig:legend-names4}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/legend-names-5} \caption{A demonstration of the different forms legend title can take.\label{fig:legend-names5}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/legend-names-6} \caption{A demonstration of the different forms legend title can take.\label{fig:legend-names6}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/breaks_vs_limits-1} \caption{The difference between breaks and limits. (Left) default plot with \texttt{limits = c(4, 8), breaks = 4:8}, (middle) \texttt{breaks = c(5.5,6.5)} and (right) \texttt{limits = c(5.5 ,6.5)}. The effect on the x axis (top) and colour legend (bottom)\label{fig:breaks_vs_limits1}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/breaks_vs_limits-2} \caption{The difference between breaks and limits. (Left) default plot with \texttt{limits = c(4, 8), breaks = 4:8}, (middle) \texttt{breaks = c(5.5,6.5)} and (right) \texttt{limits = c(5.5 ,6.5)}. The effect on the x axis (top) and colour legend (bottom)\label{fig:breaks_vs_limits2}}
\end{figure}
...
\CommentTok{#> Warning: Removed 25 rows containing missing values}
\CommentTok{#> (geom_point).}
\end{Highlighting}
\end{Shaded}

\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/breaks_vs_limits-3} \caption{The difference between breaks and limits. (Left) default plot with \texttt{limits = c(4, 8), breaks = 4:8}, (middle) \texttt{breaks = c(5.5,6.5)} and (right) \texttt{limits = c(5.5 ,6.5)}. The effect on the x axis (top) and colour legend (bottom)\label{fig:breaks_vs_limits3}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/breaks_vs_limits-4} \caption{The difference between breaks and limits. (Left) default plot with \texttt{limits = c(4, 8), breaks = 4:8}, (middle) \texttt{breaks = c(5.5,6.5)} and (right) \texttt{limits = c(5.5 ,6.5)}. The effect on the x axis (top) and colour legend (bottom)\label{fig:breaks_vs_limits4}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/breaks_vs_limits-5} \caption{The difference between breaks and limits. (Left) default plot with \texttt{limits = c(4, 8), breaks = 4:8}, (middle) \texttt{breaks = c(5.5,6.5)} and (right) \texttt{limits = c(5.5 ,6.5)}. The effect on the x axis (top) and colour legend (bottom)\label{fig:breaks_vs_limits5}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/breaks_vs_limits-6} \caption{The difference between breaks and limits. (Left) default plot with \texttt{limits = c(4, 8), breaks = 4:8}, (middle) \texttt{breaks = c(5.5,6.5)} and (right) \texttt{limits = c(5.5 ,6.5)}. The effect on the x axis (top) and colour legend (bottom)\label{fig:breaks_vs_limits6}}
\end{figure}
...
\includegraphics{figures/trans-1.png}
...
\includegraphics{figures/trans-2.png}
...
\includegraphics{figures/date-scale-1.pdf}
...
\includegraphics{figures/date-scale-2.pdf}
...
\includegraphics{figures/date-scale-3.pdf}
...
\includegraphics{figures/gradient-1.png}
...
\includegraphics{figures/gradient-2.png}
...
\includegraphics{figures/gradient-3.png}
...
\includegraphics{figures/colorspace-1.png}
...
\includegraphics{figures/colorspace-2.png}
...
\includegraphics{figures/colorspace-3.png}
...
\CommentTok{#> Warning: Removed 27 rows containing missing values}
\CommentTok{#> (geom_point).}
\end{Highlighting}
\end{Shaded}

\includegraphics{figures/brewer-pal-1.pdf}
...
\includegraphics{figures/brewer-pal-2.pdf}
...
\includegraphics{figures/brewer-pal-3.pdf}
...
\includegraphics{figures/brewer-pal-4.pdf}
...
\includegraphics{figures/brewer-pal-5.pdf}
...
\includegraphics{figures/brewer-pal-6.pdf}
...
\includegraphics{figures/scale-manual-1.pdf}
...
\includegraphics{figures/scale-manual-2.pdf}
...
\CommentTok{#> Warning: Removed 32 rows containing missing values}
\CommentTok{#> (geom_point).}
\end{Highlighting}
\end{Shaded}

\includegraphics{figures/scale-manual-3.pdf}
...
\CommentTok{#> Don't know how to automatically pick scale for object of type ts. Defaulting to continuous}
\end{Highlighting}
\end{Shaded}

\includegraphics[width=0.75\linewidth]{figures/huron-1}
...
\includegraphics[width=0.75\linewidth]{figures/huron2-1}
...
\includegraphics[width=0.75\linewidth]{figures/huron3-1}
...
\begin{figure}
\includegraphics[width=0.5\linewidth]{figures/scale-identity-1} \caption{A plot of R colours in Luv space.  A legend is unnecessary, because the colour of the points represents itself: the data and aesthetic spaces are the same.\label{fig:scale-identity}}
\end{figure}
...
\begin{figure}
\includegraphics[width=3.5in]{figures/legend-geom-1} \caption{Legends produced by geom: point, line, point and line, and bar.\label{fig:legend-geom}}
\end{figure}
...
\begin{figure}
\includegraphics[width=3in]{figures/legend-merge-1} \caption{Colour legend, shape legend, colour + shape legend.\label{fig:legend-merge}}
\end{figure}

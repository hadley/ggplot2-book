...
\NormalTok{+}\StringTok{   }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =} \NormalTok{level -}\StringTok{ }\DecValTok{5}\NormalTok{), }\DataTypeTok{colour =} \StringTok{"blue"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\NormalTok{+}\StringTok{   }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =} \NormalTok{level -}\StringTok{ }\DecValTok{5}\NormalTok{, }\DataTypeTok{colour =} \StringTok{"below"}\NormalTok{)) }
\end{Highlighting}
\end{Shaded}
...
\NormalTok{+}\StringTok{                       }\KeywordTok{c}\NormalTok{(}\StringTok{"above"} \NormalTok{=}\StringTok{ "red"}\NormalTok{, }\StringTok{"below"} \NormalTok{=}\StringTok{ "blue"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

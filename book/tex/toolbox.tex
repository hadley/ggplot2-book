...
\CommentTok{#> }
\CommentTok{#>  # ATTENTION: maps v3.0 has an updated 'world' map.        #}
\CommentTok{#>  # Many country borders and names have changed since 1990. #}
\CommentTok{#>  # Type '?world' or 'news(package="maps")'. See README_v3. #}
...
\hypertarget{sec:uncertainty}{\section{Revealing

...
\begin{figure}
\includegraphics[width=0.24\linewidth]{figures/toolboxgeom-basic-1} \includegraphics[width=0.24\linewidth]{figures/toolboxgeom-basic-2} \includegraphics[width=0.24\linewidth]{figures/toolboxgeom-basic-3} \includegraphics[width=0.24\linewidth]{figures/toolboxgeom-basic-4} \includegraphics[width=0.24\linewidth]{figures/toolboxgeom-basic-5} \includegraphics[width=0.24\linewidth]{figures/toolboxgeom-basic-6} \includegraphics[width=0.24\linewidth]{figures/toolboxgeom-basic-7} \includegraphics[width=0.24\linewidth]{figures/toolboxgeom-basic-8} \caption{The basic geoms applied to the same data. Many give rise to to named plots (from top left to bottom right): scatterplot, bar chart, line chart, area chart, path plot, labelled scatterplot, image/level plot and polygon plot. Observe the different axis ranges for the bar, area and tile plots: these geoms take up space outside the range of the data, and so push the axes out.\label{fig:geom-basic}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.49\linewidth]{figures/toolboxgeom-1d-con-1} \includegraphics[width=0.49\linewidth]{figures/toolboxgeom-1d-con-2} \caption{(Left) Never rely on the default parameters to get a revealing view of the distribution.  (Right) Zooming in on the x axis, \texttt{xlim = c(55, 70)}, and selecting a smaller bin width, \texttt{binwidth = 0.1}, reveals far more detail. We can see that the distribution is slightly skew-right. Don't forget to include information about important parameters (like bin width) in the caption.\label{fig:geom-1d-con}}
\end{figure}
...
\begin{figure}
\includegraphics[width=\linewidth]{figures/toolboxcompare-dist-1} \includegraphics[width=\linewidth]{figures/toolboxcompare-dist-2} \includegraphics[width=\linewidth]{figures/toolboxcompare-dist-3} \caption{Three views of the distribution of depth and cut. From top to bottom: faceted histogram, a conditional density plot, and frequency polygons. All show an interesting pattern: as quality increases, the distribution shifts to the left and becomes more symmetric.\label{fig:compare-dist}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/toolboxoverp-glyph-1} \includegraphics[width=0.32\linewidth]{figures/toolboxoverp-glyph-2} \includegraphics[width=0.32\linewidth]{figures/toolboxoverp-glyph-3} \caption{Modifying the glyph used can help with mild to moderate overplotting.  From left to right: the default shape, \texttt{shape = 1} (hollow points), and \texttt{shape= "."} (pixel points).\label{fig:overp-glyph}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/toolboxoverp-alpha-1} \includegraphics[width=0.32\linewidth]{figures/toolboxoverp-alpha-2} \includegraphics[width=0.32\linewidth]{figures/toolboxoverp-alpha-3} \caption{Using alpha blending to alleviate overplotting in sample data from a bivariate normal.  Alpha values from left to right: 1/3, 1/5, 1/10.\label{fig:overp-alpha}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/toolboxoverp-jitter-1} \includegraphics[width=0.32\linewidth]{figures/toolboxoverp-jitter-2} \includegraphics[width=0.32\linewidth]{figures/toolboxoverp-jitter-3} \includegraphics[width=0.32\linewidth]{figures/toolboxoverp-jitter-4} \includegraphics[width=0.32\linewidth]{figures/toolboxoverp-jitter-5} \includegraphics[width=0.32\linewidth]{figures/toolboxoverp-jitter-6} \caption{A plot of table vs. depth from the diamonds data, showing the use of jitter and alpha blending to alleviate overplotting in discrete data. From left to right: geom point, geom jitter with default jitter, geom jitter with horizontal jitter of 0.5 (half the gap between bands), alpha of 1/10, alpha of 1/50, alpha of 1/200.\label{fig:overp-jitter}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/toolboxoverp-bin-1} \includegraphics[width=0.32\linewidth]{figures/toolboxoverp-bin-2} \includegraphics[width=0.32\linewidth]{figures/toolboxoverp-bin-3} \includegraphics[width=0.32\linewidth]{figures/toolboxoverp-bin-4} \includegraphics[width=0.32\linewidth]{figures/toolboxoverp-bin-5} \includegraphics[width=0.32\linewidth]{figures/toolboxoverp-bin-6} \caption{Binning with, top row, square bins, and bottom row, hexagonal bins. Left column uses default parameters, middle column \texttt{bins = 10}, and right column \texttt{binwidth = c(0.02, 200)}. Legends have been omitted to save space.\label{fig:overp-bin}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.4\linewidth]{figures/toolboxoverp-density-1} \includegraphics[width=0.4\linewidth]{figures/toolboxoverp-density-2} \includegraphics[width=0.4\linewidth]{figures/toolboxoverp-density-3} \includegraphics[width=0.4\linewidth]{figures/toolboxoverp-density-4} \caption{Using density estimation to model and visualise point densities.  (Top) Image displays of the density; (bottom) point and contour based displays.\label{fig:overp-density}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.49\linewidth]{figures/toolboxborders-1} \includegraphics[width=0.49\linewidth]{figures/toolboxborders-2} \caption{Example using the borders function.  (Left) All cities with population (as of January 2006) of greater than half a million, (right) cities in Texas.\label{fig:borders}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.49\linewidth]{figures/toolboxchoropleth-1} \includegraphics[width=0.49\linewidth]{figures/toolboxchoropleth-2} \caption{Two choropleth maps showing number of assaults (left) and the ratio of assaults to murders (right).\label{fig:choropleth}}
\end{figure}
...
\includegraphics[width=0.49\linewidth]{figures/toolboxiowa-1}
...
\begin{figure}
\includegraphics[width=0.49\linewidth]{figures/toolboxldata-1} \includegraphics[width=0.49\linewidth]{figures/toolboxldata-2} \caption{Data transformed to remove most obvious effects. (Left) Both x and y axes are log10 transformed to remove non-linearity. (Right) The major linear trend is removed.\label{fig:ldata}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.49\linewidth]{figures/toolboxmodel-cat-1} \includegraphics[width=0.49\linewidth]{figures/toolboxmodel-cat-2} \caption{Displaying uncertainty in model estimates for colour. (Left) Marginal effect of colour. (Right) conditional effects of colour for different levels of carat. Error bars show 95\% pointwise confidence intervals.\label{fig:model-cat}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.49\linewidth]{figures/toolboxmodel-cont-1} \includegraphics[width=0.49\linewidth]{figures/toolboxmodel-cont-2} \caption{Displaying uncertainty in model estimates for carat. (Left) marginal effect of carat. (Right) conditional effects of carat for different levels of colour. Bands show 95\% point-wise confidence intervals.\label{fig:model-cont}}
\end{figure}
...
\includegraphics[width=\linewidth]{figures/toolboxumep-1}
\includegraphics[width=\linewidth]{figures/toolboxumep-2}
\includegraphics[width=\linewidth]{figures/toolboxumep-3}
\includegraphics[width=\linewidth]{figures/toolboxumep-4}
\includegraphics[width=\linewidth]{figures/toolboxumep-5}
\includegraphics[width=\linewidth]{figures/toolboxumep-6}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/toolboxmiss-basic-1} \includegraphics[width=0.32\linewidth]{figures/toolboxmiss-basic-2} \includegraphics[width=0.32\linewidth]{figures/toolboxmiss-basic-3} \caption{Using size to display weights. No weighting (left), weighting by population (centre) and by area (right).\label{fig:miss-basic}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.49\linewidth]{figures/toolboxweight-lm-1} \includegraphics[width=0.49\linewidth]{figures/toolboxweight-lm-2} \caption{An unweighted line of best fit (left) and weighted by population size (right).\label{fig:weight-lm}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.49\linewidth]{figures/toolboxweight-hist-1} \includegraphics[width=0.49\linewidth]{figures/toolboxweight-hist-2} \caption{The difference between an unweighted (left) and weighted (right) histogram. The unweighted histogram shows number of counties, while the weighted histogram shows population. The weighting considerably changes the interpretation!\label{fig:weight-hist}}
\end{figure}

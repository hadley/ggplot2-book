...
\item
  ...
  variable to solid, dotted and dashed lines. \index{Line plot}
...
\end{Shaded}
  ...
  \item
    extrafont, \url{https://github.com/wch/extrafont}, by Winston
    Change, converts fonts to a standard format that all devices can
    use.
  \end{itemize}
...
them, e.g. \texttt{aes(group = interaction(school\_id, student\_id))}.
\indexf{interaction}
...
\item
  ...
  \texttt{aes(group = 1)}. Why? What happens if that is omitted? What's
  the difference between \texttt{aes(group = 1)} and
...
\begin{figure}[H]
  \includegraphics[width=0.5\linewidth]{_figures/toolbox/unnamed-chunk-16-1}%
  \includegraphics[width=0.5\linewidth]{_figures/toolbox/unnamed-chunk-16-2}
\end{figure}
...
\begin{figure}[H]
  \includegraphics[width=0.5\linewidth]{_figures/toolbox/unnamed-chunk-21-1}%
  \includegraphics[width=0.5\linewidth]{_figures/toolbox/unnamed-chunk-21-2}
\end{figure}
...
\begin{figure}[H]
  \includegraphics[width=0.333\linewidth]{_figures/toolbox/unnamed-chunk-22-1}%
  \includegraphics[width=0.333\linewidth]{_figures/toolbox/unnamed-chunk-22-2}%
  \includegraphics[width=0.333\linewidth]{_figures/toolbox/unnamed-chunk-22-3}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# TODO: add na.rm back}
\KeywordTok{ggplot}\NormalTok{(diamonds, }\KeywordTok{aes}\NormalTok{(depth)) +}\StringTok{ }
\StringTok{  }\KeywordTok{geom_freqpoly}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{colour =} \NormalTok{cut), }\DataTypeTok{binwidth =} \FloatTok{0.1}\NormalTok{) +}
\StringTok{  }\KeywordTok{xlim}\NormalTok{(}\DecValTok{58}\NormalTok{, }\DecValTok{68}\NormalTok{) +}\StringTok{ }
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.position =} \StringTok{"none"}\NormalTok{)}
\CommentTok{#> Warning: Removed 669 rows containing non-finite values (stat_bin).}
\CommentTok{#> Warning: Removed 10 rows containing missing values (geom_path).}
\KeywordTok{ggplot}\NormalTok{(diamonds, }\KeywordTok{aes}\NormalTok{(depth)) +}\StringTok{ }
...
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.position =} \StringTok{"none"}\NormalTok{)}
\CommentTok{#> Warning: Removed 669 rows containing non-finite values (stat_bin).}
\CommentTok{#> Warning: Removed 10 rows containing missing values (geom_bar).}
\end{Highlighting}
\end{Shaded}
...
\end{Shaded}
  ...
  \begin{figure}[H]
    \includegraphics[width=0.5\linewidth]{_figures/toolbox/unnamed-chunk-25-1}%
    \includegraphics[width=0.5\linewidth]{_figures/toolbox/unnamed-chunk-25-2}
  \end{figure}
\item
...
\item
  ...
  Lewin-Koh, and Maechler 2008). \index{hexbin}
...
\StringTok{  }\KeywordTok{geom_bin2d}\NormalTok{(}\DataTypeTok{binwidth =} \DecValTok{1}\NormalTok{) +}\StringTok{ }
...
\CommentTok{#> Warning: Removed 36 rows containing non-finite values (stat_bin2d).}

\KeywordTok{ggplot}\NormalTok{(diamonds, }\KeywordTok{aes}\NormalTok{(table, depth, }\DataTypeTok{z =} \NormalTok{price)) +}\StringTok{ }
\StringTok{  }\KeywordTok{geom_raster}\NormalTok{(}\DataTypeTok{binwidth =} \DecValTok{1}\NormalTok{, }\DataTypeTok{stat =} \StringTok{"summary_2d"}\NormalTok{, }\DataTypeTok{fun =} \NormalTok{mean) +}\StringTok{ }
\StringTok{  }\KeywordTok{xlim}\NormalTok{(}\DecValTok{50}\NormalTok{, }\DecValTok{70}\NormalTok{) +}\StringTok{ }
\StringTok{  }\KeywordTok{ylim}\NormalTok{(}\DecValTok{50}\NormalTok{, }\DecValTok{70}\NormalTok{)}
\CommentTok{#> Warning: Removed 36 rows containing non-finite values}
\CommentTok{#> (stat_summary2d).}
\end{Highlighting}
\end{Shaded}
...
\item
  ggsubplot, \url{https://github.com/garrettgman/ggsubplot}: embed
  subplots within larger graphics.
\item

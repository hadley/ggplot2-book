...
\CommentTok{#> Linking to GEOS 3.6.2, GDAL 2.2.3, PROJ 4.9.3}
\NormalTok{c18 <-}\StringTok{ }\KeywordTok{us_boundaries}\NormalTok{(}\KeywordTok{as.Date}\NormalTok{(}\StringTok{"1820-01-01"}\NormalTok{))}
\NormalTok{c18 <-}\StringTok{ }\KeywordTok{as}\NormalTok{(c18, }\StringTok{"Spatial"}\NormalTok{)}
...
\CommentTok{#> 1 -87.6  35     1 FALSE     1  5   5.1}
\CommentTok{#> 2 -87.6  35     2 FALSE     1  5   5.1}
\CommentTok{#> 3 -87.6  35     3 FALSE     1  5   5.1}
\CommentTok{#> 4 -87.6  35     4 FALSE     1  5   5.1}
\CommentTok{#> 5 -87.5  35     5 FALSE     1  5   5.1}
\CommentTok{#> 6 -87.3  35     6 FALSE     1  5   5.1}
...
\CommentTok{#> 2 alger   0.051     8972      93.9    2.37  }
\CommentTok{#> 3 allegan 0.049    90509      95.9    1.60  }
\CommentTok{#> 4 alpena  0.034    30605      99.2    0.114 }
\CommentTok{#> 5 antrim  0.031    18185      98.4    0.126 }
\CommentTok{#> 6 arenac  0.021    14931      98.4    0.0670}
...
\CommentTok{#> Warning: Removed 997 rows containing missing values (stat_boxplot).}
\end{Highlighting}
\end{Shaded}

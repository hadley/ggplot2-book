...
\CommentTok{#> Scale for 'x' is already present. Adding another scale for 'x', which will replace the existing scale.}
\CommentTok{#> Scale for 'y' is already present. Adding another scale for 'y', which will replace the existing scale.}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/iterate-limits-1} \includegraphics[width=0.32\linewidth]{figures/iterate-limits-2} \includegraphics[width=0.32\linewidth]{figures/iterate-limits-3} \includegraphics[width=0.32\linewidth]{figures/iterate-limits-4} \includegraphics[width=0.32\linewidth]{figures/iterate-limits-5} \includegraphics[width=0.32\linewidth]{figures/iterate-limits-6} \caption{When 'zooming' in on the plot, it's useful to use \texttt{last\_plot()} iteratively to quickly find the best view. The final plot adds a line with slope 1 and intercept 0, confirming it is the square diamonds that are missing.\label{fig:iterate-limits}}
\end{figure}
...
\includegraphics{figures/gradient-rb-1.pdf}
...
\includegraphics{figures/gradient-rb-2.pdf}
...
\includegraphics{figures/quiet-1.pdf}
...
\includegraphics{figures/quiet-2.pdf}
...
\includegraphics{figures/geom-lm-1.pdf}
...
\includegraphics{figures/geom-lm-2.pdf}
...
\includegraphics[width=0.75\linewidth]{figures/pcp_data-1}
...
\includegraphics[width=0.75\linewidth]{figures/pcp_data-2}

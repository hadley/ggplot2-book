...
\includegraphics{figures/smooth-1.pdf}
...
\includegraphics{figures/smooth-2.pdf}
...
\includegraphics{figures/smooth-by-hand-1.pdf}
...
\includegraphics{figures/smooth-by-hand-2.pdf}
...
\includegraphics{figures/gam-1.pdf}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/series-wide-1} \caption{When the economics dataset is stored in wide format, it is easy to create separate time series plots for each variable (left and centre), and easy to create scatterplots comparing them (right).\label{fig:series-wide1}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/series-wide-2} \caption{When the economics dataset is stored in wide format, it is easy to create separate time series plots for each variable (left and centre), and easy to create scatterplots comparing them (right).\label{fig:series-wide2}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/series-wide-3} \caption{When the economics dataset is stored in wide format, it is easy to create separate time series plots for each variable (left and centre), and easy to create scatterplots comparing them (right).\label{fig:series-wide3}}
\end{figure}
...
\includegraphics{figures/series-methods-1.pdf}
...
\includegraphics{figures/series-methods-2.pdf}
...
\includegraphics{figures/series-scaling-1.pdf}
...
\includegraphics{figures/series-scaling-2.pdf}
...
\includegraphics{figures/pcp-1.png}
...
\includegraphics{figures/pcp-2.png}
...
\includegraphics{figures/pcp-3.png}
...
\includegraphics{figures/pcp-4.png}
...
\includegraphics{figures/pcp-colour-1.png}
...
\includegraphics{figures/pcp-colour-2.png}
...
\begin{figure}
\includegraphics[width=\linewidth]{figures/pcp-facet-1} \caption{Faceting allows us to display each group in its own panel, highlighting the fact that there seems to be considerable variation within each group, and suggesting that we need more groups in our clustering.\label{fig:pcp-facet}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.4\linewidth]{figures/plot-lm-1} \caption{The output from \texttt{plot.lm()} for a simple model.\label{fig:plot-lm1}}
\end{figure}\begin{figure}
\includegraphics[width=0.4\linewidth]{figures/plot-lm-2} \caption{The output from \texttt{plot.lm()} for a simple model.\label{fig:plot-lm2}}
\end{figure}\begin{figure}
\includegraphics[width=0.4\linewidth]{figures/plot-lm-3} \caption{The output from \texttt{plot.lm()} for a simple model.\label{fig:plot-lm3}}
\end{figure}\begin{figure}
\includegraphics[width=0.4\linewidth]{figures/plot-lm-4} \caption{The output from \texttt{plot.lm()} for a simple model.\label{fig:plot-lm4}}
\end{figure}
...
\includegraphics{figures/fortify-mod-1.pdf}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/fortify-fr-1} \caption{(Left) Basic fitted values-residual plot. (Middle) With standardised residuals. (Right) With size proportional to Cook's distance. It is easy to modify the basic plots when we have access to all of the data.\label{fig:fortify-fr1}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/fortify-fr-2} \caption{(Left) Basic fitted values-residual plot. (Middle) With standardised residuals. (Right) With size proportional to Cook's distance. It is easy to modify the basic plots when we have access to all of the data.\label{fig:fortify-fr2}}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.32\linewidth]{figures/fortify-fr-3} \caption{(Left) Basic fitted values-residual plot. (Middle) With standardised residuals. (Right) With size proportional to Cook's distance. It is easy to modify the basic plots when we have access to all of the data.\label{fig:fortify-fr3}}
\end{figure}
...
\includegraphics{figures/fortify-full-1.pdf}
...
\includegraphics{figures/fortify-full-2.pdf}

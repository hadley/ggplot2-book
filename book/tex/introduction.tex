...
\CommentTok{#>  date     2016-02-11}
\CommentTok{#> Packages ------------------------------------------------------------}
\CommentTok{#>  package      * version    date      }
\CommentTok{#>  assertthat     0.1        2013-12-06}
\CommentTok{#>  BH             1.58.0-1   2015-05-21}
\CommentTok{#>  broom          0.4.0      2015-11-30}
\CommentTok{#>  colorspace     1.2-6      2015-03-11}
\CommentTok{#>  DBI            0.3.1      2014-09-24}
\CommentTok{#>  dichromat      2.0-0      2013-01-24}
\CommentTok{#>  digest         0.6.9      2016-01-08}
\CommentTok{#>  dplyr        * 0.4.3.9000 2015-12-05}
\CommentTok{#>  ggplot2      * 2.0.0      2015-12-18}
\CommentTok{#>  gtable         0.1.2.9000 2016-02-03}
\CommentTok{#>  labeling       0.3        2014-08-23}
\CommentTok{#>  lattice        0.20-33    2015-07-14}
\CommentTok{#>  lazyeval       0.1.10     2015-01-02}
\CommentTok{#>  magrittr       1.5        2014-11-22}
\CommentTok{#>  MASS           7.3-45     2015-11-10}
\CommentTok{#>  mnormt         1.5-3      2015-05-25}
\CommentTok{#>  munsell        0.4.2      2013-07-11}
\CommentTok{#>  nlme           3.1-122    2015-08-19}
\CommentTok{#>  plyr           1.8.3      2015-06-12}
\CommentTok{#>  psych          1.5.8      2015-08-30}
\CommentTok{#>  R6             2.1.2      2016-01-26}
\CommentTok{#>  RColorBrewer   1.1-2      2014-12-07}
\CommentTok{#>  Rcpp           0.12.3     2016-01-10}
\CommentTok{#>  reshape2       1.4.1      2014-12-06}
\CommentTok{#>  scales         0.3.0.9000 2016-01-25}
\CommentTok{#>  stringi        1.0-1      2015-10-22}
\CommentTok{#>  stringr        1.0.0.9000 2015-12-11}
\CommentTok{#>  tidyr        * 0.4.0.9000 2016-02-01}
\CommentTok{#>  source                         }
\CommentTok{#>  CRAN (R 3.2.0)                 }
\CommentTok{#>  CRAN (R 3.2.0)                 }
\CommentTok{#>  CRAN (R 3.2.2)                 }
\CommentTok{#>  CRAN (R 3.2.0)                 }
\CommentTok{#>  CRAN (R 3.2.0)                 }
\CommentTok{#>  CRAN (R 3.2.0)                 }
\CommentTok{#>  CRAN (R 3.2.3)                 }
\CommentTok{#>  local                          }
\CommentTok{#>  CRAN (R 3.2.3)                 }
\CommentTok{#>  local                          }
\CommentTok{#>  CRAN (R 3.2.0)                 }
...
\CommentTok{#>  local                          }
\CommentTok{#>  CRAN (R 3.2.0)                 }
\CommentTok{#>  Github (hadley/stringr@a67f8f0)}
\CommentTok{#>  local}
\end{Highlighting}
\end{Shaded}

\hypertarget{cha:introduction}{%
\chapter{Introduction}\label{cha:introduction}}

\hypertarget{welcome-to-ggplot2}{%
...
\hypertarget{sec:other-resources}{%
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{devtools}\OperatorTok{::}\KeywordTok{session_info}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{"ggplot2"}\NormalTok{, }\StringTok{"dplyr"}\NormalTok{, }\StringTok{"broom"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

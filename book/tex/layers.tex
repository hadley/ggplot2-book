...
\hypertarget{sec:position}{\section{Position
...
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{group =} \NormalTok{cut), }\DataTypeTok{stat =} \StringTok{"count"}\NormalTok{) +}\StringTok{ }

...
\CommentTok{#> 1 chevrolet    corv~   5.7  1999     8 manu~ r        16    26}
\CommentTok{#> 2 pontiac      gran~   3.8  2008     6 auto~ f        18    28}
\CommentTok{#> 3 pontiac      gran~   5.3  2008     8 auto~ f        16    25}
\CommentTok{#> 4 volkswagen   jetta   1.9  1999     4 manu~ f        33    44}
\CommentTok{#> 5 volkswagen   new ~   1.9  1999     4 manu~ f        35    44}
\CommentTok{#> 6 volkswagen   new ~   1.9  1999     4 auto~ f        29    41}
\CommentTok{#> # ... with 2 more variables: fl <chr>, class <chr>}
\end{Highlighting}
\end{Shaded}

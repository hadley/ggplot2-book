...
\CommentTok{#> 2 0.21  Prem~ E     SI1      59.8    61   326  3.89  3.84  2.31}
\CommentTok{#> 3 0.23  Good  E     VS1      56.9    65   327  4.05  4.07  2.31}
\CommentTok{#> 4 0.290 Prem~ I     VS2      62.4    58   334  4.2   4.23  2.63}
\CommentTok{#> 5 0.31  Good  J     SI2      63.3    58   335  4.34  4.35  2.75}
\CommentTok{#> 6 0.24  Very~ J     VVS2     62.8    57   336  3.94  3.96  2.48}
\CommentTok{#> # ... with 5.204e+04 more rows, and 2 more variables:}
\CommentTok{#> #   lcarat <dbl>, lprice <dbl>}
...
\CommentTok{#> 1 Abilene  2000     1    72  5.38e6  71400      701       6.3 2000 }
\CommentTok{#> 2 Abilene  2000     2    98  6.50e6  58700      746       6.6 2000.}
\CommentTok{#> 3 Abilene  2000     3   130  9.28e6  58100      784       6.8 2000.}
\CommentTok{#> 4 Abilene  2000     4    98  9.73e6  68600      785       6.9 2000.}
\CommentTok{#> 5 Abilene  2000     5   141  1.06e7  67300      794       6.8 2000.}
\CommentTok{#> 6 Abilene  2000     6   156  1.39e7  66900      780       6.6 2000.}
...
\CommentTok{#>   city      mod   }
\CommentTok{#> * <chr>     <list>}
\CommentTok{#> 1 Abilene   <lm>  }
\CommentTok{#> 2 Amarillo  <lm>  }
\CommentTok{#> 3 Arlington <lm>  }
\CommentTok{#> 4 Austin    <lm>  }
\CommentTok{#> 5 Bay Area  <lm>  }
\CommentTok{#> 6 Beaumont  <lm>  }
...
\CommentTok{#> 1 Abil~     0.530         0.500 0.282      17.9 1.50e-23    12}
\CommentTok{#> 2 Amar~     0.449         0.415 0.302      13.0 7.41e-18    12}
\CommentTok{#> 3 Arli~     0.513         0.483 0.267      16.8 2.75e-22    12}
\CommentTok{#> 4 Aust~     0.487         0.455 0.310      15.1 2.04e-20    12}
\CommentTok{#> 5 Bay ~     0.555         0.527 0.265      19.9 1.45e-25    12}
\CommentTok{#> 6 Beau~     0.430         0.395 0.275      12.0 1.18e-16    12}
\CommentTok{#> # ... with 40 more rows, and 5 more variables: logLik <dbl>,}
...
\CommentTok{#>   <chr>       <dbl> <fct>           <dbl>   <dbl>  <dbl>  <dbl>}
\CommentTok{#> 1 Abil~        6.17 1                6.54  0.0704 -0.372 0.0625}
\CommentTok{#> 2 Abil~        6.61 2                6.90  0.0704 -0.281 0.0625}
\CommentTok{#> 3 Abil~        7.02 3                7.22  0.0704 -0.194 0.0625}
\CommentTok{#> 4 Abil~        6.61 4                7.29  0.0704 -0.676 0.0625}
\CommentTok{#> 5 Abil~        7.14 5                7.46  0.0704 -0.319 0.0625}
\CommentTok{#> 6 Abil~        7.29 6                7.54  0.0704 -0.259 0.0625}
\CommentTok{#> # ... with 8,028 more rows, and 3 more variables: .sigma <dbl>,}
\CommentTok{#> #   .cooksd <dbl>, .std.resid <dbl>}
\end{Highlighting}
\end{Shaded}

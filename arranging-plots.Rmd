...
p1 + 
  inset_element(
    ...
    left = 0.4, 
    bottom = 0.4, 
    right = unit(1, "npc") - unit(2, "cm"), 
    top = unit(1, "npc") - unit(2, "cm"),
    align_to = "full"
  )
```
...
```{r}
p1 + inset_element(p2 / p4, left = 0.5, bottom = 0.1, right = 0.95, top = 0.9)
```

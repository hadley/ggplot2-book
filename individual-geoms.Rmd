...
*   `geom_text()` adds text to a plot. It requires a `label` aesthetic that 
    provides the text to display, and has a number of parameters (`angle`,
    `family`, `fontface`, `hjust` and `vjust`) that control the appearance
    of the text.

...
base <- ggplot(toy, aes(const, up)) + geom_point(aes(colour = text))

base + xlab("X axis") + ylab("Y axis")
base + labs(x = "X axis", y = "Y axis", colour = "Colour\nlegend")
```
...
`r columns(2, 2/3)`
```{r, cache.vars=toy}
base <- ggplot(toy, aes(const, text)) + geom_point()
...
p <- ggplot(toy, aes(const, up, colour = text))
p + geom_point()
p + geom_point() + geom_path(aes(group = 1))
p + geom_raster(aes(fill = text))
```
...
ggplot(toy, aes(up, up)) + 
  ...
  geom_point(aes(colour = text), size = 2) 
...
ggplot(toy, aes(const, up)) + geom_point(aes(colour = text))
ggplot(toy, aes(const, up)) + geom_point(aes(shape = text))
ggplot(toy, aes(const, up)) + geom_point(aes(shape = text, colour = text))
```
...
base <- ggplot(toy, aes(up, up)) + 
  geom_point(aes(colour = text), size = 3) + 
  xlab(NULL) + 
  ylab(NULL)

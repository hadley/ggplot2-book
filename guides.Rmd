...
base + scale_x_date(limits = lim, date_labels = "%m/%Y")
```

For an alternative approach, note that the scales package contains `label_dates()` and `label_dates_short()` that use the same formatting strings to specify the appearance of dates. 

...
It also contains tools relevant to other data types:

* `scales::label_dates()` allows you to specify a date format
* `scales::label_wrap()` allows you to wrap long strings across lines

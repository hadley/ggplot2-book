...
Note that it is also possible to use markdown in axis labels with the help of the ggtext package [@ggtext], by setting the relevant theme element to `ggtext::element_markdown()`. Modifying theme settings is discussed further in Chapter \@ref(polishing).

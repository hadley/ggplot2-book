...
\begin{itemize}
  ...
  \item \f{geom_bar(stat = "identity")} makes a \textbf{barchart}. We need \code{stat="identity"} because the default stat automatically counts values (so is essentially a 1d geom, see \secref{sec:distributions}). The identity stat leaves the data unchanged. \index{Barchart} \indexf{geom_bar}
...
\input{_include/d424d453d1582c8b83772bbab6e5cb1c.tex}
% END
...
\input{_include/b47af016ca1686988c74cdc845fd383e.tex}
% END
...
\input{_include/67b13473cf9487c5e598a972921f00c6.tex}
% END
...
\begin{itemize}
  ...
  \input{_include/8cf62791d68d21beefbf2b52c99fc4bd.tex}  
  % END
  ...
  \input{_include/b4fe91f6772926baf1af14db892af615.tex}  
  % END
...
\begin{itemize}
  ...
  \input{_include/b3ff4d5c084f2ef9cf4c352e58ecf259.tex}  
  % END
  ...
  \input{_include/465e99e4bb7cfb4262539cdee4f53ba6.tex}  
  % END
  ...
  \input{_include/e1e31f335093514e9b31d84956c6cd57.tex}  
  % END
...
\begin{itemize}
  ...
  \input{_include/fde70a2e589899693c6a35645928f079.tex}  
  % END
  ...
  \input{_include/1f5f29bb9f20b8d3e7f4bfa422812368.tex}  
  % END
...
\input{_include/3510763722e58ff3c38f11ba53ee48c9.tex}
% END
...
%   geom="polygon")
\input{_include/b2583277e89543a252e01b6d815377f7.tex}
% END
...
\input{_include/4b7305607b8f495d5c62ee489caf5623.tex}
% END
...
\input{_include/d921c939c5afb491cfaebea9989a80bd.tex}
% END
...
\input{_include/73aa4c4f4f1ef2994f5d73a710a8e048.tex}
% END
...
\input{_include/54f6c072dcce36c4a2a0d7156986f03d.tex}
% END
...
\input{_include/ff3f74737f6baece0b35ddc795365597.tex}
% END
...
\input{_include/6bef6603ebf4e183f4948c047d5dbcea.tex}
% END
...
\input{_include/d447c59f35c10cdc89cebde3275c5a1a.tex}
% END
...
\input{_include/e873b4398967b4c68b08097b42ec995d.tex}
% END
...
\input{_include/5fbfbb792dfb63463250327ce72b78fb.tex}
% END
...
%   scale_area()
\input{_include/0276b291d495c5b053b9be67a416b0c6.tex}
% END
...
\input{_include/e01d5aef7c6a57bf719e49e46761b29b.tex}
% END
...
%   ylab("population")
\input{_include/347bd025965ad23d89f8ee89aef2fff0.tex}
% END

...
% 
%   \item The \code{mpg} data set records fuel economy information for 20 models of car in 1999 and 2008.
% 
%   \item The \code{movies} data set contains user ratings for nearly 60,000 movies.
% \end{itemize}
...
\begin{itemize}
  ...
  \item \f{geom_line} makes a \textbf{line plot}.  The \code{group} aesthetic determine which observations are connected, see Section~\ref{sub:grouping} for more details. \code{geom_path} is similar to a \code{geom_line}, but lines are connected in the order they appear in the data, not from left to right.  
  ...
  \item \f{geom_tile} makes a image plot or level plot.  The tiles form a regular tessellation of the plane and are typically have the \code{fill} aesthetic mapped to another variable.
...
\input{_include/87eedf8ced4ef92e5141e43410533159.tex}
% END
...
%   view of the distribution.  \Rightc, zooming in on the x axis, 
...
\input{_include/80e72b08247651b4aa46210dc080a38e.tex}
% END
...
\input{_include/9042d9e2a6b7c04561183ac733eaa80e.tex}
% END

\noindent Both the histogram and frequency polygon geom use \code{stat_bin}.  This statistic produces two output variables \code{count} and \code{density}.  The count is the default as it is most interpretable.  The density is basically the count divided by the total count, and is useful when you want to compare the shape of the distributions, not the overall size.  You will often prefer this when comparing the distribution of subsets that different sizes.
...
\begin{itemize}
  ...
  \input{_include/71ac87944e40efd0d855d17d3c3df99d.tex}  
  % END
  
  \item \code{geom_jitter} = \code{position_jitter} + \code{geom_point}: a crude way of looking at discrete distributions by adding random noise to the the discrete values so that they don't overplot.  An example is shown in Figure~\ref{fig:geom-jitter} created with the code below.
  ...
  %   for smaller datasets.  Car class vs continuous variable city mpg (left)
  %   and discrete variable drive train (right).
  % 
  % qplot(class, cty, data=mpg, geom="jitter")
  % qplot(class, drv, data=mpg, geom="jitter")
  \input{_include/6dacf3953cc3d9a36f03bb1bb3f805fc.tex}  
  % END
  ...
  \input{_include/9f0979bd9ca5eaca7ce46ff31539741e.tex}  
  % END
...
\begin{itemize}
  ...
  \input{_include/04cef180c262c22c3c3b2eb3929a2188.tex}  
  % END
  ...
  \input{_include/055f6312d86b0c8fdbb145de82fc3231.tex}  
  % END
  ...
  \input{_include/2b18b8ab79cb8c49ce199c80cbadd425.tex}  
  % END
...
\begin{itemize}
  ...
  \input{_include/f2114f889827adb9f8768d9e9339131a.tex}  
  % END
  ...
  \input{_include/3ea8b3205b6e6cd5250ebb7937729002.tex}  
  % END
...
Another approach to dealing with overplotting is to add data summaries to help guide the eye to the true shape of the pattern within the data.  For example,  you could add a smooth line showing the centre of the data with \code{geom_smooth}. Sections~\ref{sec:summary} has more ideas.
...
%   population (as at January 2006) of greater than half a million, and right, 
%   cities in Texas. 
% 
% data(us.cities)
...
\input{_include/e3397d83f3a763d573dea7e950be7c16.tex}
% END
...
%   geom="polygon")
\input{_include/179d05d76e99e79ae50de3711a921690.tex}
% END
...
\input{_include/9b50335de7d4732e04929353894b84e2.tex}
% END
...
\input{_include/1583bf832c4ebef19ce3a44abdc50374.tex}
% END
...
\input{_include/8b173aade750d170123cc29cf9eb4cf9.tex}
% END
...
\input{_include/f88e757ddced00abae130eb4ab433686.tex}
% END
...
\input{_include/3a95798e07fe7cf2f07a407236b06eb2.tex}
% END
...
\input{_include/9c261efe9e6f39b9af1c431fb504aa92.tex}
% END
...
\input{_include/045bb9910392f5f90000842aa4266476.tex}
% END
...
\input{_include/85acca402bafb3a810004ab5e253b052.tex}
% END
...
%   scale_area()
\input{_include/f51b4c49558f4035769fc745e3bc6a5c.tex}
% END
...
% FIGLIST
%   LABEL: weight-lm
%   CAPTION: A unweighted line of best fit (left) and weighted by population
%   size (right).
%
...
\input{_include/dc4f65dee6a0fc02cd1c760456d4388b.tex}
% END
...
% FIGLISTING
%   LABEL: weight-hist
%   CAPTION: The different between a unweighted (left) and weighted (right)
...
%   ylab("population")
\input{_include/3322adb82f2e0f94756dec7a824fed01.tex}
% END

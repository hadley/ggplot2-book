...
\begin{itemize}
  ...
  \item \code{geom_text} adds labels at the specified points.  This is the only geom in this group that requires another aesthetic: \code{label}.
...
\input{_include/757b776419e2d0c387e0c080775625e0.tex}
% END
...
\input{_include/190533de1afcf87c9a707600e055fb40.tex}
% END
...
%   xlim = c(55, 70), binwidth = 0.1, facets = cut ~ .)
% qplot(depth, data = diamonds, geom = "histogram", 
%   xlim = c(58, 68), binwidth = 0.1, fill = cut, position = "fill", 
%   colour = I(NA))
% qplot(depth, ..density.., data = diamonds, geom = "freqpoly", 
%   xlim = c(55, 70), binwidth = 0.1, colour = cut)
\input{_include/d7ef76873cf356b6f494819ffdb007f8.tex}
% END
...
\begin{itemize}
  \item \code{fill = NA}, colour mapped to another variable, allows you to superimpose the densities of multiple groups on a single plot.  Combined with facetting, this can allow the display of many densities on a single plot.
...
\input{_include/75333576417421d37fdde2962f06b517.tex}
% END

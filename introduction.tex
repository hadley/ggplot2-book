...
Chapter~\ref{cha:strategy} describes strategies to automate the production of \ggplot graphics and to reduce the amount of duplication in your code.  To go beyond the built-in components, you will need to write your own. 

% Chapter~\ref{cha:writing-your-own} describes the internal structure of \ggplot objects and how you can create to new ones.
